"""
Django settings for financial_web project.
...
SECRET_KEY = 'django-insecure-)fzpl$$=*ioy7-@&4ubor0(*=-5ypg!i2*ngik&%bb0a5)3sf5'
...
ROOT_URLCONF = 'financial_web.urls'
...
WSGI_APPLICATION = 'financial_web.wsgi.application'
