...
class Account(models.Model):
    ...
    account_id = ShortUUIDField(unique=True, length=7, max_length=25, prefix="DEX", alphabet="123456789")
    pin_number = ShortUUIDField(unique=True, length=4, max_length=7, prefix="217", alphabet="123456789")
    ref_code = ShortUUIDField(unique=True, length=10, max_length=25, alphabet="abcdefgh123456789")
...
class Kyc(models.Model):
    ...
    identity_image = models.ImageField(upload_to="kyc", null=False, blank=False, default=None)
